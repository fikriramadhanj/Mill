      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" name="noFJ" class="form-control" value="{{$fakturJual->no_fj}}"  readonly=""required />
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input type="text" name="tglFJ" class="form-control datepicker fj-tanggal-faktur" value="{{ $fakturJual->tgl_fj}}" required />
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <textarea name="keterangan" class="form-control" value="{{$fakturJual->keterangan}}"required ></textarea>
            </div>
          </div>
        </div>
      </div>
